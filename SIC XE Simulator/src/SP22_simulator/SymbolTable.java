...
//
//
//			DO NOT USED THIS CLASS
//			I WRITE DETAILS IN REPORT
//			CHECK REPORT PAGE 7
//
//
//
...
public class SymbolTable {
	...
	ArrayList < String > typeList ;				// BYTE, WORD
	ArrayList < Integer > lengthList ;			// Each length
	 ...
	 * @param strType : CHANGED. Symbol type
	 * @param iLength : CHANGED. Symbol length <br>
	 *                <br>
	 *                주의 : 만약 중복된 symbol이 putSymbol을 통해서 입력된다면 이는 프로그램 코드에 문제가 있음을
	 *                나타낸다. 매칭되는 주소값의 변경은 modifySymbol()을 통해서 이루어져야 한다.
	 */
	public void putSymbol(String symbol, int address , String strType , int iLength )
	{
		symbolList.add ( symbol ) ;
		addressList.add ( address ) ;
		typeList.add ( strType ) ;
		lengthList.add ( iLength ) ;
	}
